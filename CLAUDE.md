...
Reson8 is a self-hosted voice and text communication platform (TeamSpeak-3-style) with an Electron desktop client and a standalone Node.js server. Current version: 1.2.0, all planned phases (1–9) complete — see "Project history" below before assuming something is unbuilt.
