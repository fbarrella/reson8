...
Reson8 is a self-hosted voice and text communication platform (TeamSpeak-3-style) with an Electron desktop client and a standalone Node.js server. Current version: 2.2.1, phases 1–13 complete — see "Project history" below before assuming something is unbuilt.
